...
datasets = [
    dict(type='JourneyDBDataset', data_root='/root/paddlejob/workspace/box5_home/disk1/vis/songyuxin02/data/JourneyDB/train/images/', annotation_path='/root/paddlejob/workspace/box5_home/disk1/vis/songyuxin02/data/JourneyDB/train/train_anno.jsonl', prompt_type='prompt', weight=9),
    dict(type='UltraChatDataset', data_root='/root/paddlejob/workspace/env_run/afs_baihua/zhaochuyang/data/llmdit/ultrachat/', weight=1),
]
